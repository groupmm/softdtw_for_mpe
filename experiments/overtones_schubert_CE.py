...
enable_strongly_aligned_training = True
scale_loss_with = None
enable_time_warp_aug = False
overtone_targets = True
hcqt_feature_rate = 43.06640625
output_is_sigmoid = True
if (enable_strongly_aligned_training and not overtone_targets) or softdtw_distance == "cross_entropy":
